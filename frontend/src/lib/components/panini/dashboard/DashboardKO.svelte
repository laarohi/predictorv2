<script lang="ts">
	...
	// Hint is empty for top rows — exact/outcome counts and movement are
	// busy chrome for what is dense (1-line-per-row) name-first readout,
	// and both are one tap away on the full standings page anyway.
